...
class ProjectileTest {
	...
	@Test
	void testProjectile() {
		Projectile Projectile1 = new Projectile(5000, 0, 5000, 0);
	...
	@Test
	void testSetName() {
		Projectile Projectile1 = new Projectile(100, 0, 100, 0);
	...
	public void testGetName() {
		Projectile Projectile1 = new Projectile(100, 90, 0, 100);
