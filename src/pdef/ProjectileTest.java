...
class ProjectileTest {
	...
	void testProjectile() {
		...
		Projectile Projectile1 = new Projectile("Projectile Z", new PolarCoord(100, Math.PI, origin));
	...
	void testSetName() {
		Point2D origin = new Point2D(400,300);
		Projectile Projectile1 = new Projectile("Projectile A", new PolarCoord(50, Math.PI, origin));
	...
	public void testGetName() {
		Point2D origin = new Point2D(400,300);
		Projectile Projectile1 = new Projectile("Projectile A", new PolarCoord (75, 10.5, origin));
